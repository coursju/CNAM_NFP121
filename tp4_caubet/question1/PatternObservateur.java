...
public class PatternObservateur extends junit.framework.TestCase {
    ...
    public void test1() {
        ...
        assertFalse(o1.senders().empty() || o2.senders().empty());
        assertTrue(o1.senders().size() == 2);
        assertTrue(o2.senders().size() == 2);
        assertTrue(o1.arguments().elementAt(0) =="test" && o1.arguments().elementAt(1) == " 1 ");
        assertTrue(o2.arguments().elementAt(0) =="test" && o2.arguments().elementAt(1) == " 1 ");
    ...
    public void test2() {
        ...
        assertTrue(o.senders().size() == 4);
        assertTrue(o.arguments().elementAt(0) =="testA" && o.arguments().elementAt(1) == " A ");
        assertTrue(o.arguments().elementAt(2) =="testB" && o.arguments().elementAt(3) == " B ");
